...
> 标签: com, docker, github.com, go, golang

## 简介

The Docker engine and SDK for Go
...
- 官网：https://docker.io
- Go 文档：https://pkg.go.dev/github.com/docker/docker
...
- go mod 下载：`go get github.com/docker/docker@v28.5.2+incompatible`
- 模块代理：https://proxy.golang.org/github.com/docker/docker/@v/list
