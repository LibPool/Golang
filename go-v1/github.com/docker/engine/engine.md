...
> 标签: com, docker, engine, github.com, go, golang

## 简介

Go module，由 index.golang.org 收录：github.com/docker/engine。

Go 语言目前为大版本 1.x；本库收录于 go-v1。

## 官网

- Go 文档：https://pkg.go.dev/github.com/docker/engine
- 源码仓库：https://github.com/docker/engine
...
- go mod 下载：`go get github.com/docker/engine@v17.12.1-ce-rc2+incompatible`
- 模块代理：https://proxy.golang.org/github.com/docker/engine/@v/list
