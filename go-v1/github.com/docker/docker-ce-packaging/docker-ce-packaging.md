...
> 标签: com, docker, docker-ce-packaging, github.com, go, golang

## 简介

Go module，由 index.golang.org 收录：github.com/docker/docker-ce-packaging。

Go 语言目前为大版本 1.x；本库收录于 go-v1。

## 官网

- Go 文档：https://pkg.go.dev/github.com/docker/docker-ce-packaging
- 源码仓库：https://github.com/docker/docker-ce-packaging

## 历史版本号

- 当前版本：v20.10.0-beta1+incompatible
...
- go mod 下载：`go get github.com/docker/docker-ce-packaging@v20.10.0-beta1+incompatible`
- 模块代理：https://proxy.golang.org/github.com/docker/docker-ce-packaging/@v/list
