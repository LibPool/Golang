...
> 标签: com, github.com, go, golang, moby

## 简介

Go module，由 index.golang.org 收录：github.com/moby/moby。

Go 语言目前为大版本 1.x；本库收录于 go-v1。

## 官网

- Go 文档：https://pkg.go.dev/github.com/moby/moby
- 源码仓库：https://github.com/moby/moby
...
- go mod 下载：`go get github.com/moby/moby@v28.5.2+incompatible`
- 模块代理：https://proxy.golang.org/github.com/moby/moby/@v/list
