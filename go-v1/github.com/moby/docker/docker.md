...
> 标签: com, docker, github.com, go, golang, moby

## 简介

Go module，由 index.golang.org 收录：github.com/moby/docker。

Go 语言目前为大版本 1.x；本库收录于 go-v1。

## 官网

- Go 文档：https://pkg.go.dev/github.com/moby/docker
- 源码仓库：https://github.com/moby/docker
...
- go mod 下载：`go get github.com/moby/docker@v28.5.2+incompatible`
- 模块代理：https://proxy.golang.org/github.com/moby/docker/@v/list
