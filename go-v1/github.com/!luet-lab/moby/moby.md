# github.com/Luet-lab/moby

> 标签: Luet-lab, com, github.com, go, golang, moby

## 简介

Go module，由 index.golang.org 收录：github.com/Luet-lab/moby。

Go 语言目前为大版本 1.x；本库收录于 go-v1。

## 官网

- Go 文档：https://pkg.go.dev/github.com/Luet-lab/moby
- 源码仓库：https://github.com/Luet-lab/moby

## 历史版本号

- 当前版本：v17.12.1-ce-rc2+incompatible
...
- go mod 下载：`go get github.com/Luet-lab/moby@v17.12.1-ce-rc2+incompatible`
- 模块代理：https://proxy.golang.org/github.com/%21luet-lab/moby/@v/list
