...
> 标签: com, github.com, go, golang, moby, mudler

## 简介

Go module，由 index.golang.org 收录：github.com/mudler/moby。

Go 语言目前为大版本 1.x；本库收录于 go-v1。

## 官网

- Go 文档：https://pkg.go.dev/github.com/mudler/moby
- 源码仓库：https://github.com/mudler/moby
...
- go mod 下载：`go get github.com/mudler/moby@v17.12.1-ce-rc2+incompatible`
- 模块代理：https://proxy.golang.org/github.com/mudler/moby/@v/list
