...
> 标签: com, etcd, etcd-io, github.com, go, golang

## 简介

Go module，由 index.golang.org 收录：github.com/etcd-io/etcd。

Go 语言目前为大版本 1.x；本库收录于 go-v1。

## 官网

- Go 文档：https://pkg.go.dev/github.com/etcd-io/etcd
- 源码仓库：https://github.com/etcd-io/etcd

## 历史版本号

- 当前版本：v3.3.27+incompatible
...
- go mod 下载：`go get github.com/etcd-io/etcd@v3.3.27+incompatible`
- 模块代理：https://proxy.golang.org/github.com/etcd-io/etcd/@v/list
